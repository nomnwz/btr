<div id="section6" class="section-container section-6 section-sticky position-relative text-light w-100 min-vh-100 px-site py-5 d-flex flex-column flex-md-row row mx-0">
    ...
    <div class="col-12 col-md-6 d-flex px-0 position-relative">
        <div class="section-content">
            <ul class="content-list list-group <?php echo ( is_rtl() ? 'pe-0' : 'ps-0' ); ?>">
                ...
                <li class="content list-group-item bg-transparent text-light px-0 py-3 rounded-0 border-0 border-bottom border-light">
                    <p><?php _e( 'All the excitement and adrenaline without the risks – Our team of global security professionals will keep you safe.', 'btr' ); ?></p>
                </li>
